    ...
    <table border="0" width="100%" style="border-collapse: collapse;">
        <tr>
            <td width="50%" valign="top" style="vertical-align: top; padding: 0 10px 0 0;">
                ...
                <p>
                    <?= h($order->getAttribute("billing_last_name")) . " " . h($order->getAttribute("billing_first_name")) ?>様<br>
                    ...
                    <?php
                    echo $order->getAttribute('billing_address')->getPostalCode();
                    echo '<br>';
                    $sh = Loader::helper('lists/states_provinces');
                    echo $sh->getStateProvinceName($order->getAttribute('billing_address')->getStateProvince(),'JP');
                    echo '<br>';
                    echo $order->getAttribute('billing_address')->getCity();
                    echo '<br>';
                    echo $order->getAttribute('billing_address')->getAddress1();
                    echo '<br>';
                    echo $order->getAttribute('billing_address')->getAddress2();
                    ?>
                    <br><br>
            ...
            <td style="vertical-align: top; padding: 0;">
                <?php if ($order->isShippable()) { ?>
                    ...
                    <p>
                        <?= h($order->getAttribute("shipping_last_name")) . " " . h($order->getAttribute("shipping_first_name")) ?>様<br />
                        ...
                        <?php if ($shippingaddress) {
                            ...
                            echo $order->getAttribute('shipping_address')->getPostalCode();
                            echo '<br>';
                            echo $sh->getStateProvinceName($order->getAttribute('shipping_address')->getStateProvince(),'JP');
                            echo '<br>';
                            echo $order->getAttribute('shipping_address')->getCity();
                            echo '<br>';
                            echo $order->getAttribute('shipping_address')->getAddress1();
                            echo '<br>';
                            echo $order->getAttribute('shipping_address')->getAddress2();
                        }
                        ?>
                    </p>
                <?php } ?>
