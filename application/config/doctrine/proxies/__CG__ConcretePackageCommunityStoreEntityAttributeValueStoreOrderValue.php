 ...
 */
class StoreOrderValue extends \Concrete\Package\CommunityStore\Entity\Attribute\Value\StoreOrderValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'order', 'attribute_key', 'generic_value', 'attribute_value'];
        }
