...
class FreeShippingShippingMethod extends \Concrete\Package\CommunityStore\Src\CommunityStore\Shipping\Method\Types\FreeShippingShippingMethod implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'minimumAmount', 'maximumAmount', 'minimumWeight', 'maximumWeight', 'countries', 'countriesSelected', 'smtmID', 'smID', 'disableEnabled', 'view', 'viewPath', 'theme', 'controllerActionPath', 'themeViewTemplate', 'helpers', 'sets', 'action', 'request', 'parameters', 'app'];
        }
