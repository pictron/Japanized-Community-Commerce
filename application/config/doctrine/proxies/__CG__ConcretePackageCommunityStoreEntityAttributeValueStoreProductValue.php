...
namespace DoctrineProxies\__CG__\Concrete\Package\CommunityStore\Entity\Attribute\Value;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class StoreProductValue extends \Concrete\Package\CommunityStore\Entity\Attribute\Value\StoreProductValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'product', 'attribute_key', 'generic_value', 'attribute_value'];
        }
